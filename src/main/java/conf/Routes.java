...
public class Routes implements ApplicationRoutes {
    ...
    public void init(Router router) {  
        ...
        router.POST().route("/adminlogin").with(ApplicationController::adminLogin);
		router.GET().route("/showAllBooks").with(ApplicationController.class,"showAllBooks");
		router.GET().route("/main").with(ApplicationController.class,"main");
